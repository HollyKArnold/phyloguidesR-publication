# Author: Arnold
# Sim 1: Calculate JRF distance
################################################################################
# SET VARIABLES
################################################################################
CORES = 60
SAVE_FILE_NAME = "hvr_jrf_random_pairs.rds"
################################################################################
# LOAD LIBRARIES
################################################################################
library(phangorn)
...
print("Working on V1...")
v1 = calculate_jrf_distance_random_pairs(trees1 = VFull, trees2 = V1, cores = CORES)
print("Working on V1...DONE")

print("Working on V2...")
v2 = calculate_jrf_distance_random_pairs(trees1 = VFull, trees2 = V2, cores = CORES)
print("Working on V2...DONE")

print("Working on V3...")
v3 = calculate_jrf_distance_random_pairs(trees1 = VFull, trees2 = V3, cores = CORES)
print("Working on V3...DONE")

print("Working on V4...")
v4 = calculate_jrf_distance_random_pairs(trees1 = VFull, trees2 = V4, cores = CORES)
print("Working on V4...DONE")

print("Working on V5...")
v5 = calculate_jrf_distance_random_pairs(trees1 = VFull, trees2 = V5, cores = CORES)
print("Working on V5...DONE")

print("Working on V6...")
v6 = calculate_jrf_distance_random_pairs(trees1 = VFull, trees2 = V6, cores = CORES)
print("Working on V6...DONE")

print("Working on V7...")
v7 = calculate_jrf_distance_random_pairs(trees1 = VFull, trees2 = V7, cores = CORES)
print("Working on V7...DONE")

print("Working on V8...")
v8 = calculate_jrf_distance_random_pairs(trees1 = VFull, trees2 = V8, cores = CORES)
print("Working on V8...DONE")

print("Working on V9...")
v9 = calculate_jrf_distance_random_pairs(trees1 = VFull, trees2 = V9, cores = CORES)
print("Working on V9...DONE")

print("Working on VFull_Guides...")
vfull_guides = calculate_jrf_distance_random_pairs(trees1 = VFull, trees2 = VFull_guides, cores = CORES)
print("Working on VFull_Guides...DONE")

print("Working on VFull_control...")
vfull = calculate_jrf_distance_random_pairs(trees1 = VFull, trees2 = VFull_control, cores = CORES)
print("Working on VFull_control...DONE")

print("Working on V1 Guides...")
v1_guides = calculate_jrf_distance_random_pairs(trees1 = VFull, trees2 = V1_guides, cores = CORES)
print("Working on V1 Guides...DONE")

print("Working on V2 Guides...")
v2_guides = calculate_jrf_distance_random_pairs(trees1 = VFull, trees2 = V2_guides, cores = CORES)
print("Working on V2 Guides...DONE")

print("Working on V3 Guides...")
v3_guides = calculate_jrf_distance_random_pairs(trees1 = VFull, trees2 = V3_guides, cores = CORES)
print("Working on V3 Guides...DONE")

print("Working on V4 Guides...")
v4_guides = calculate_jrf_distance_random_pairs(trees1 = VFull, trees2 = V4_guides, cores = CORES)
print("Working on V4 Guides...DONE")

print("Working on V5 Guides...")
v5_guides = calculate_jrf_distance_random_pairs(trees1 = VFull, trees2 = V5_guides, cores = CORES)
print("Working on V5 Guides...DONE")

print("Working on V6 Guides...")
v6_guides = calculate_jrf_distance_random_pairs(trees1 = VFull, trees2 = V6_guides, cores = CORES)
print("Working on V6 Guides...DONE")

print("Working on V7 Guides...")
v7_guides = calculate_jrf_distance_random_pairs(trees1 = VFull, trees2 = V7_guides, cores = CORES)
print("Working on V7 Guides...DONE")

print("Working on V8 Guides...")
v8_guides = calculate_jrf_distance_random_pairs(trees1 = VFull, trees2 = V8_guides, cores = CORES)
print("Working on V8 Guides...DONE")

print("Working on V9 Guides...")
v9_guides = calculate_jrf_distance_random_pairs(trees1 = VFull, trees2 = V9_guides, cores = CORES)
