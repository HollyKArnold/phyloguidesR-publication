################################################################################
# SIMm 3
# sim_analysis_ov_pid.R
# Produce PID metrics for overlapping HVRs
################################################################################
...
################################################################################
CORES = 30
SAVE_FILE_NAME = "ov_pid_random_pairs.rds"
...
V4_V3V4_mix = calculate_pid_distance_random_pairs(VFull, V4_V3V4_mix, cores = CORES)
V4_V3V4_mix_guides = calculate_pid_distance_random_pairs(VFull, V4_V3V4_mix_guides, cores = CORES)
