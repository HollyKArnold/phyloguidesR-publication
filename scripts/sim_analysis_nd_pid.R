...
FILE_SAVENAME = "sim_analysis_nd_pid.rds" # Filename to save output
...
VFull_control = calculate_pid_distance_random_pairs(VFull, VFull_control, cores = CORES)
VFull_guides = calculate_pid_distance_random_pairs(VFull, VFull_guides, cores = CORES)

V1V2 = calculate_pid_distance_random_pairs(VFull, V1V2, cores = CORES)
V1V3 = calculate_pid_distance_random_pairs(VFull, V1V3, cores = CORES)
V3V4 = calculate_pid_distance_random_pairs(VFull, V3V4, cores = CORES)
V3V5 = calculate_pid_distance_random_pairs(VFull, V3V5, cores = CORES)
V4 = calculate_pid_distance_random_pairs(VFull, V4, cores = CORES)
V4V5 = calculate_pid_distance_random_pairs(VFull, V4V5, cores = CORES)
nd_mix = calculate_pid_distance_random_pairs(VFull, nd_mix, cores = CORES)

V1V2_guides = calculate_pid_distance_random_pairs(VFull, V1V2_guides, cores = CORES)
V1V3_guides = calculate_pid_distance_random_pairs(VFull, V1V3_guides, cores = CORES)
V3V4_guides = calculate_pid_distance_random_pairs(VFull, V3V4_guides, cores = CORES)
V3V5_guides = calculate_pid_distance_random_pairs(VFull, V3V5_guides, cores = CORES)
V4_guides = calculate_pid_distance_random_pairs(VFull, V4_guides, cores = CORES)
V4V5_guides = calculate_pid_distance_random_pairs(VFull, V4V5_guides, cores = CORES)
nd_mix_guides = calculate_pid_distance_random_pairs(VFull, nd_mix_guides, cores = CORES)
