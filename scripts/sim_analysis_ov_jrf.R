################################################################################
# Author: Arnold
# SIM 3: sim_analysis_ov_jrf.R
# Produce JRF metrics for overlapping HRVs
################################################################################
...
################################################################################
CORES = 30
SAVE_FILE_NAME = "ov_jrf_random_pairs.rds"
...
################################################################################
# 1: Determine how guides impact integration of overlapping regions.
################################################################################
...
V4_V3V4_mix = calculate_jrf_distance_random_pairs(VFull, V4_V3V4_mix, cores = CORES)
V4_V3V4_mix_guides = calculate_jrf_distance_random_pairs(VFull, V4_V3V4_mix_guides, cores = CORES)
