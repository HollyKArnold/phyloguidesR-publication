################################################################################
# sim_analysis_ov_nye.R
# Sim 3: Produce NYE metrics for overlapping HRVs
################################################################################
...
################################################################################
CORES = 30
SAVE_FILE_NAME = "ov_nye_random_pairs.rds"
...
################################################################################
# 1: Determine if guides allow integration of VRs in overlapping regions. 
################################################################################
...
V4_V3V4_mix = calculate_nye_distance_random_pairs(VFull, V4_V3V4_mix, cores = CORES)
V4_V3V4_mix_guides = calculate_nye_distance_random_pairs(VFull, V4_V3V4_mix_guides, cores = CORES)
