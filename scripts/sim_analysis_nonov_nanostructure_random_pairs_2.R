...
# CORES
################################################################################
CORES = 50 # Number of cores to use for the simulation
SUBTREE_SIZE = 2 # Subtree size
N = 100 # trees to look at per simulation

SAVE_FILE_NAME = paste0(c("nonov_nanostructure_", SUBTREE_SIZE, "_random_pairs.rds"), sep = "", collapse = "")
################################################################################
# LOAD LIBRARIES
################################################################################
library(phangorn)
...
print("Working on controls...DONE")

print("Working on guideless")
...
V5V7 = calculate_shared_subtrees_dist_random_pairs(VFull, V5V7, cores = CORES, n = SUBTREE_SIZE)
print("Working on guideless... DONE")

print("Working on guides")
...
V5V7_guides = calculate_shared_subtrees_dist_random_pairs(VFull, V5V7_guides, cores = CORES, n = SUBTREE_SIZE)
print("Working on guides...DONE")

print("working on mixes...")
V1V2_V3V4_V5V7_mix = calculate_shared_subtrees_dist_random_pairs(VFull, V1V2_V3V4_V5V7_mix, cores = CORES, n = SUBTREE_SIZE)
V1V2_V3V4_V5V7_mix_guides = calculate_shared_subtrees_dist_random_pairs(VFull, V1V2_V3V4_V5V7_mix_guides, cores = CORES, n = SUBTREE_SIZE)
print("working on mixes...DONE")
