...
################################################################################
CORES = 10
SAVE_FILE_NAME = "experimental_demo_msd_random_pairs.rds"
################################################################################
# LOAD LIBRARIES
################################################################################
library(phangorn)
...
short = calculate_msd_distance_random_pairs(trees1 = long, trees2 = short, cores = CORES)
short_guides = calculate_msd_distance_random_pairs(trees1 = long, trees2 = short_guides, cores = CORES)
long_control = calculate_msd_distance_random_pairs(trees1 = long, trees2 = long_control, cores = CORES)
...
setwd(dir.out)
saveRDS(exp_demo_msd, file = SAVE_FILE_NAME, compress = TRUE)
