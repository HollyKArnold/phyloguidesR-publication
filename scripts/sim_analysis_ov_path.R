################################################################################
# Sim 3
# sim_analysis_ov_path.R
# Produce PATH metrics for overlapping HRVs
################################################################################
...
################################################################################
CORES = 30
SAVE_FILE_NAME = "ov_path_random_pairs.rds"
...
V4_V3V4_mix = calculate_path_dist_random_pairs(VFull, V4_V3V4_mix, cores = CORES)
V4_V3V4_mix_guides = calculate_path_dist_random_pairs(VFull, V4_V3V4_mix_guides, cores = CORES)
