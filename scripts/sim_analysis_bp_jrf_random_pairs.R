# Author: Arnold
# SIM 2: sim_analysis_bp_jrf_random_pairs.R
# Calculates distances between long-read and short-read tress across VR and short-read lengths.
...
VFull_control_jrf = calculate_jrf_distance_random_pairs(VFull, VFull_control, cores = CORES)
VFull_guides_jrf = calculate_jrf_distance_random_pairs(VFull, VFull_guides, cores = CORES)
print("Calculating distance of controls...DONE")

print("Calculating distance of V1...")
V1_L50_jrf = calculate_jrf_distance_random_pairs(VFull, V1_L50, cores = CORES)
V1_L100_jrf = calculate_jrf_distance_random_pairs(VFull, V1_L100, cores = CORES)
V1_L200_jrf = calculate_jrf_distance_random_pairs(VFull, V1_L200, cores = CORES)
V1_L300_jrf = calculate_jrf_distance_random_pairs(VFull, V1_L300, cores = CORES)
V1_L400_jrf = calculate_jrf_distance_random_pairs(VFull, V1_L400, cores = CORES)
V1_L500_jrf = calculate_jrf_distance_random_pairs(VFull, V1_L500, cores = CORES)

V1_L50_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V1_L50_guides, cores = CORES)
V1_L100_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V1_L100_guides, cores = CORES)
V1_L200_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V1_L200_guides, cores = CORES)
V1_L300_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V1_L300_guides, cores = CORES)
V1_L400_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V1_L400_guides, cores = CORES)
V1_L500_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V1_L500_guides, cores = CORES)

print("Calculating distance of V2...")
V2_L50_jrf = calculate_jrf_distance_random_pairs(VFull, V2_L50, cores = CORES)
V2_L100_jrf = calculate_jrf_distance_random_pairs(VFull, V2_L100, cores = CORES)
V2_L200_jrf = calculate_jrf_distance_random_pairs(VFull, V2_L200, cores = CORES)
V2_L300_jrf = calculate_jrf_distance_random_pairs(VFull, V2_L300, cores = CORES)
V2_L400_jrf = calculate_jrf_distance_random_pairs(VFull, V2_L400, cores = CORES)
V2_L500_jrf = calculate_jrf_distance_random_pairs(VFull, V2_L500, cores = CORES)

V2_L50_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V2_L50_guides, cores = CORES)
V2_L100_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V2_L100_guides, cores = CORES)
V2_L200_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V2_L200_guides, cores = CORES)
V2_L300_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V2_L300_guides, cores = CORES)
V2_L400_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V2_L400_guides, cores = CORES)
V2_L500_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V2_L500_guides, cores = CORES)

print("Calculating distance of V3...")
V3_L50_jrf = calculate_jrf_distance_random_pairs(VFull, V3_L50, cores = CORES)
V3_L100_jrf = calculate_jrf_distance_random_pairs(VFull, V3_L100, cores = CORES)
V3_L200_jrf = calculate_jrf_distance_random_pairs(VFull, V3_L200, cores = CORES)
V3_L300_jrf = calculate_jrf_distance_random_pairs(VFull, V3_L300, cores = CORES)
V3_L400_jrf = calculate_jrf_distance_random_pairs(VFull, V3_L400, cores = CORES)
V3_L500_jrf = calculate_jrf_distance_random_pairs(VFull, V3_L500, cores = CORES)

V3_L50_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V3_L50_guides, cores = CORES)
V3_L100_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V3_L100_guides, cores = CORES)
V3_L200_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V3_L200_guides, cores = CORES)
V3_L300_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V3_L300_guides, cores = CORES)
V3_L400_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V3_L400_guides, cores = CORES)
V3_L500_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V3_L500_guides, cores = CORES)

print("Calculating distance of V4...")
V4_L50_jrf = calculate_jrf_distance_random_pairs(VFull, V4_L50, cores = CORES)
V4_L100_jrf = calculate_jrf_distance_random_pairs(VFull, V4_L100, cores = CORES)
V4_L200_jrf = calculate_jrf_distance_random_pairs(VFull, V4_L200, cores = CORES)
V4_L300_jrf = calculate_jrf_distance_random_pairs(VFull, V4_L300, cores = CORES)
V4_L400_jrf = calculate_jrf_distance_random_pairs(VFull, V4_L400, cores = CORES)
V4_L500_jrf = calculate_jrf_distance_random_pairs(VFull, V4_L500, cores = CORES)

V4_L50_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V4_L50_guides, cores = CORES)
V4_L100_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V4_L100_guides, cores = CORES)
V4_L200_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V4_L200_guides, cores = CORES)
V4_L300_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V4_L300_guides, cores = CORES)
V4_L400_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V4_L400_guides, cores = CORES)
V4_L500_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V4_L500_guides, cores = CORES)

print("Calculating distance of V5...")
V5_L50_jrf = calculate_jrf_distance_random_pairs(VFull, V5_L50, cores = CORES)
V5_L100_jrf = calculate_jrf_distance_random_pairs(VFull, V5_L100, cores = CORES)
V5_L200_jrf = calculate_jrf_distance_random_pairs(VFull, V5_L200, cores = CORES)
V5_L300_jrf = calculate_jrf_distance_random_pairs(VFull, V5_L300, cores = CORES)
V5_L400_jrf = calculate_jrf_distance_random_pairs(VFull, V5_L400, cores = CORES)
V5_L500_jrf = calculate_jrf_distance_random_pairs(VFull, V5_L500, cores = CORES)

V5_L50_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V5_L50_guides, cores = CORES)
V5_L100_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V5_L100_guides, cores = CORES)
V5_L200_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V5_L200_guides, cores = CORES)
V5_L300_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V5_L300_guides, cores = CORES)
V5_L400_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V5_L400_guides, cores = CORES)
V5_L500_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V5_L500_guides, cores = CORES)

print("Calculating distance of V6...")
V6_L50_jrf = calculate_jrf_distance_random_pairs(VFull, V6_L50, cores = CORES)
V6_L100_jrf = calculate_jrf_distance_random_pairs(VFull, V6_L100, cores = CORES)
V6_L200_jrf = calculate_jrf_distance_random_pairs(VFull, V6_L200, cores = CORES)
V6_L300_jrf = calculate_jrf_distance_random_pairs(VFull, V6_L300, cores = CORES)
V6_L400_jrf = calculate_jrf_distance_random_pairs(VFull, V6_L400, cores = CORES)

V6_L50_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V6_L50_guides, cores = CORES)
V6_L100_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V6_L100_guides, cores = CORES)
V6_L200_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V6_L200_guides, cores = CORES)
V6_L300_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V6_L300_guides, cores = CORES)
V6_L400_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V6_L400_guides, cores = CORES)

print("Calculating distance of V7...")
V7_L50_jrf = calculate_jrf_distance_random_pairs(VFull, V7_L50, cores = CORES)
V7_L100_jrf = calculate_jrf_distance_random_pairs(VFull, V7_L100, cores = CORES)
V7_L200_jrf = calculate_jrf_distance_random_pairs(VFull, V7_L200, cores = CORES)
V7_L300_jrf = calculate_jrf_distance_random_pairs(VFull, V7_L300, cores = CORES)

V7_L50_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V7_L50_guides, cores = CORES)
V7_L100_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V7_L100_guides, cores = CORES)
V7_L200_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V7_L200_guides, cores = CORES)
V7_L300_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V7_L300_guides, cores = CORES)

print("Calculating distance of V8...")
V8_L50_jrf = calculate_jrf_distance_random_pairs(VFull, V8_L50, cores = CORES)
V8_L100_jrf = calculate_jrf_distance_random_pairs(VFull, V8_L100, cores = CORES)
V8_L200_jrf = calculate_jrf_distance_random_pairs(VFull, V8_L200, cores = CORES)

V8_L50_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V8_L50_guides, cores = CORES)
V8_L100_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V8_L100_guides, cores = CORES)
V8_L200_guides_jrf = calculate_jrf_distance_random_pairs(VFull, V8_L200_guides, cores = CORES)

setwd(dir.save)
save.image(file = "sim_analysis_bp_jrf_save.RData", compress = TRUE)

bp_jrf = 
  data.frame("VFull_control_jrf" = VFull_control_jrf,
             "VFull_guides_jrf" = VFull_guides_jrf,
             "V1_L50_jrf" = V1_L50_jrf,
             "V1_L100_jrf" = V1_L100_jrf,
             "V1_L200_jrf" = V1_L200_jrf,
             "V1_L300_jrf" = V1_L300_jrf,
             "V1_L400_jrf" = V1_L400_jrf,
             "V1_L500_jrf" = V1_L500_jrf,
             "V1_L50_guides_jrf" = V1_L50_guides_jrf,
             "V1_L100_guides_jrf" = V1_L100_guides_jrf,
             "V1_L200_guides_jrf" = V1_L200_guides_jrf,
             "V1_L300_guides_jrf" = V1_L300_guides_jrf,
             "V1_L400_guides_jrf" = V1_L400_guides_jrf,
             "V1_L500_guides_jrf" = V1_L500_guides_jrf,
             "V2_L50_jrf" = V2_L50_jrf,
             "V2_L100_jrf" = V2_L100_jrf,
             "V2_L200_jrf" = V2_L200_jrf,
             "V2_L300_jrf" = V2_L300_jrf,
             "V2_L400_jrf" = V2_L400_jrf,
             "V2_L500_jrf" = V2_L500_jrf,
             "V2_L50_guides_jrf" = V2_L50_guides_jrf,
             "V2_L100_guides_jrf" = V2_L100_guides_jrf,
             "V2_L200_guides_jrf" = V2_L200_guides_jrf,
             "V2_L300_guides_jrf" = V2_L300_guides_jrf,
             "V2_L400_guides_jrf" = V2_L400_guides_jrf,
             "V2_L500_guides_jrf" = V2_L500_guides_jrf,
             "V3_L50_jrf" = V3_L50_jrf,
             "V3_L100_jrf" = V3_L100_jrf,
             "V3_L200_jrf" = V3_L200_jrf,
             "V3_L300_jrf" = V3_L300_jrf,
             "V3_L400_jrf" = V3_L400_jrf,
             "V3_L500_jrf" = V3_L500_jrf,
             "V3_L50_guides_jrf" = V3_L50_guides_jrf,
             "V3_L100_guides_jrf" = V3_L100_guides_jrf,
             "V3_L200_guides_jrf" = V3_L200_guides_jrf,
             "V3_L300_guides_jrf" = V3_L300_guides_jrf,
             "V3_L400_guides_jrf" = V3_L400_guides_jrf,
             "V3_L500_guides_jrf" = V3_L500_guides_jrf,
             "V4_L50_jrf" = V4_L50_jrf,
             "V4_L100_jrf" = V4_L100_jrf,
             "V4_L200_jrf" = V4_L200_jrf,
             "V4_L300_jrf" = V4_L300_jrf,
             "V4_L400_jrf" = V4_L400_jrf,
             "V4_L500_jrf" = V4_L500_jrf,
             "V4_L50_guides_jrf" = V4_L50_guides_jrf,
             "V4_L100_guides_jrf" = V4_L100_guides_jrf,
             "V4_L200_guides_jrf" = V4_L200_guides_jrf,
             "V4_L300_guides_jrf" = V4_L300_guides_jrf,
             "V4_L400_guides_jrf" = V4_L400_guides_jrf,
             "V4_L500_guides_jrf" = V4_L500_guides_jrf,
             "V5_L50_jrf" = V5_L50_jrf,
             "V5_L100_jrf" = V5_L100_jrf,
             "V5_L200_jrf" = V5_L200_jrf,
             "V5_L300_jrf" = V5_L300_jrf,
             "V5_L400_jrf" = V5_L400_jrf,
             "V5_L500_jrf" = V5_L500_jrf,
             "V5_L50_guides_jrf" = V5_L50_guides_jrf,
             "V5_L100_guides_jrf" = V5_L100_guides_jrf,
             "V5_L200_guides_jrf" = V5_L200_guides_jrf,
             "V5_L300_guides_jrf" = V5_L300_guides_jrf,
             "V5_L400_guides_jrf" = V5_L400_guides_jrf,
             "V5_L500_guides_jrf" = V5_L500_guides_jrf,
             "V6_L50_jrf" = V6_L50_jrf,
             "V6_L100_jrf" = V6_L100_jrf,
             "V6_L200_jrf" = V6_L200_jrf,
             "V6_L300_jrf" = V6_L300_jrf,
             "V6_L400_jrf" = V6_L400_jrf,
             "V6_L50_guides_jrf" = V6_L50_guides_jrf,
             "V6_L100_guides_jrf" = V6_L100_guides_jrf,
             "V6_L200_guides_jrf" = V6_L200_guides_jrf,
             "V6_L300_guides_jrf" = V6_L300_guides_jrf,
             "V6_L400_guides_jrf" = V6_L400_guides_jrf,
             "V7_L50_jrf" = V7_L50_jrf,
             "V7_L100_jrf" = V7_L100_jrf,
             "V7_L200_jrf" = V7_L200_jrf,
             "V7_L300_jrf" = V7_L300_jrf,
             "V7_L50_guides_jrf" = V7_L50_guides_jrf,
             "V7_L100_guides_jrf" = V7_L100_guides_jrf,
             "V7_L200_guides_jrf" = V7_L200_guides_jrf,
             "V7_L300_guides_jrf" = V7_L300_guides_jrf,
             "V8_L50_jrf" = V8_L50_jrf,
             "V8_L100_jrf" = V8_L100_jrf,
             "V8_L200_jrf" = V8_L200_jrf,
             "V8_L50_guides_jrf" = V8_L50_guides_jrf,
             "V8_L100_guides_jrf" = V8_L100_guides_jrf,
             "V8_L200_guides_jrf" = V8_L200_guides_jrf)
setwd(dir.sim.out)
saveRDS(file = "bp_jrf_random_pairs.rds", object = bp_jrf)
