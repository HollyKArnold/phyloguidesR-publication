...
################################################################################
CORES = 30
SAVE_FILE_NAME = "ov_mast_random_pairs.rds"
...
################################################################################
# 1: Determine how guides x length impact topological reconstruction 
################################################################################
...
V4_rf = calculate_mast_random_pairs(VFull, V4, cores = CORES)
V3V4_rf = calculate_mast_random_pairs(VFull, V3V4, cores = CORES)
V4_guides_rf = calculate_mast_random_pairs(VFull, V4_guides, cores = CORES)
V3V4_guides_rf = calculate_mast_random_pairs(VFull, V3V4_guides, cores = CORES)
V4_V3V4_mix_rf = calculate_mast_random_pairs(VFull, V4_V3V4_mix, cores = CORES)
V4_V3V4_mix_guides_rf = calculate_mast_random_pairs(VFull, V4_V3V4_mix_guides, cores = CORES)
