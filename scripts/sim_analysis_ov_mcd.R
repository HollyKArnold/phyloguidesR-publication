################################################################################
# Sim 3
# sim_analysis_ov_mcd.R
# Produce MCD metrics for overlapping HRVs
################################################################################
...
################################################################################
CORES = 30
SAVE_FILE_NAME = "ov_mcd_random_pairs.rds"
...
V4_V3V4_mix = calculate_mcd_distance_random_pairs(VFull, V4_V3V4_mix, cores = CORES)
V4_V3V4_mix_guides = calculate_mcd_distance_random_pairs(VFull, V4_V3V4_mix_guides, cores = CORES)
