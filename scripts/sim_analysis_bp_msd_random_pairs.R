# Author: Arnold
# SIM 2: sim_analysis_bp_msd.R
# Calculate MSD distance between short-read and full-length control trees across different short-read lengths.
...
V2_L50 = read_trees(file.path(dir.hvrs["V1_L50"], file_list = list.files(path = dir.hvrs["V1_L50"], pattern = ".tre")))[1:N]
V3_L50 = read_trees(file.path(dir.hvrs["V1_L50"], file_list = list.files(path = dir.hvrs["V1_L50"], pattern = ".tre")))[1:N]
V4_L50 = read_trees(file.path(dir.hvrs["V1_L50"], file_list = list.files(path = dir.hvrs["V1_L50"], pattern = ".tre")))[1:N]
V5_L50 = read_trees(file.path(dir.hvrs["V1_L50"], file_list = list.files(path = dir.hvrs["V1_L50"], pattern = ".tre")))[1:N]
V6_L50 = read_trees(file.path(dir.hvrs["V1_L50"], file_list = list.files(path = dir.hvrs["V1_L50"], pattern = ".tre")))[1:N]
V7_L50 = read_trees(file.path(dir.hvrs["V1_L50"], file_list = list.files(path = dir.hvrs["V1_L50"], pattern = ".tre")))[1:N]
V8_L50 = read_trees(file.path(dir.hvrs["V1_L50"], file_list = list.files(path = dir.hvrs["V1_L50"], pattern = ".tre")))[1:N]
...
VFull_control_msd= calculate_msd_distance_random_pairs(VFull, VFull_control, cores = CORES)
VFull_guides_msd = calculate_msd_distance_random_pairs(VFull, VFull_guides, cores = CORES)
print("Calculating distance of controls...DONE")

print("Calculating distance of V1...")
V1_L50_msd = calculate_msd_distance_random_pairs(VFull, V1_L50, cores = CORES)
V1_L100_msd = calculate_msd_distance_random_pairs(VFull, V1_L100, cores = CORES)
V1_L200_msd = calculate_msd_distance_random_pairs(VFull, V1_L200, cores = CORES)
V1_L300_msd = calculate_msd_distance_random_pairs(VFull, V1_L300, cores = CORES)
V1_L400_msd = calculate_msd_distance_random_pairs(VFull, V1_L400, cores = CORES)
V1_L500_msd = calculate_msd_distance_random_pairs(VFull, V1_L500, cores = CORES)

V1_L50_guides_msd = calculate_msd_distance_random_pairs(VFull, V1_L50_guides, cores = CORES)
V1_L100_guides_msd = calculate_msd_distance_random_pairs(VFull, V1_L100_guides, cores = CORES)
V1_L200_guides_msd = calculate_msd_distance_random_pairs(VFull, V1_L200_guides, cores = CORES)
V1_L300_guides_msd = calculate_msd_distance_random_pairs(VFull, V1_L300_guides, cores = CORES)
V1_L400_guides_msd = calculate_msd_distance_random_pairs(VFull, V1_L400_guides, cores = CORES)
V1_L500_guides_msd = calculate_msd_distance_random_pairs(VFull, V1_L500_guides, cores = CORES)

print("Calculating distance of V2...")
V2_L50_msd = calculate_msd_distance_random_pairs(VFull, V2_L50, cores = CORES)
V2_L100_msd = calculate_msd_distance_random_pairs(VFull, V2_L100, cores = CORES)
V2_L200_msd = calculate_msd_distance_random_pairs(VFull, V2_L200, cores = CORES)
V2_L300_msd = calculate_msd_distance_random_pairs(VFull, V2_L300, cores = CORES)
V2_L400_msd = calculate_msd_distance_random_pairs(VFull, V2_L400, cores = CORES)
V2_L500_msd = calculate_msd_distance_random_pairs(VFull, V2_L500, cores = CORES)

V2_L50_guides_msd = calculate_msd_distance_random_pairs(VFull, V2_L50_guides, cores = CORES)
V2_L100_guides_msd = calculate_msd_distance_random_pairs(VFull, V2_L100_guides, cores = CORES)
V2_L200_guides_msd = calculate_msd_distance_random_pairs(VFull, V2_L200_guides, cores = CORES)
V2_L300_guides_msd = calculate_msd_distance_random_pairs(VFull, V2_L300_guides, cores = CORES)
V2_L400_guides_msd = calculate_msd_distance_random_pairs(VFull, V2_L400_guides, cores = CORES)
V2_L500_guides_msd = calculate_msd_distance_random_pairs(VFull, V2_L500_guides, cores = CORES)

print("Calculating distance of V3...")
V3_L50_msd = calculate_msd_distance_random_pairs(VFull, V3_L50, cores = CORES)
V3_L100_msd = calculate_msd_distance_random_pairs(VFull, V3_L100, cores = CORES)
V3_L200_msd = calculate_msd_distance_random_pairs(VFull, V3_L200, cores = CORES)
V3_L300_msd = calculate_msd_distance_random_pairs(VFull, V3_L300, cores = CORES)
V3_L400_msd = calculate_msd_distance_random_pairs(VFull, V3_L400, cores = CORES)
V3_L500_msd = calculate_msd_distance_random_pairs(VFull, V3_L500, cores = CORES)

V3_L50_guides_msd = calculate_msd_distance_random_pairs(VFull, V3_L50_guides, cores = CORES)
V3_L100_guides_msd = calculate_msd_distance_random_pairs(VFull, V3_L100_guides, cores = CORES)
V3_L200_guides_msd = calculate_msd_distance_random_pairs(VFull, V3_L200_guides, cores = CORES)
V3_L300_guides_msd = calculate_msd_distance_random_pairs(VFull, V3_L300_guides, cores = CORES)
V3_L400_guides_msd = calculate_msd_distance_random_pairs(VFull, V3_L400_guides, cores = CORES)
V3_L500_guides_msd = calculate_msd_distance_random_pairs(VFull, V3_L500_guides, cores = CORES)

print("Calculating distance of V4...")
V4_L50_msd = calculate_msd_distance_random_pairs(VFull, V4_L50, cores = CORES)
V4_L100_msd = calculate_msd_distance_random_pairs(VFull, V4_L100, cores = CORES)
V4_L200_msd = calculate_msd_distance_random_pairs(VFull, V4_L200, cores = CORES)
V4_L300_msd = calculate_msd_distance_random_pairs(VFull, V4_L300, cores = CORES)
V4_L400_msd = calculate_msd_distance_random_pairs(VFull, V4_L400, cores = CORES)
V4_L500_msd = calculate_msd_distance_random_pairs(VFull, V4_L500, cores = CORES)

V4_L50_guides_msd = calculate_msd_distance_random_pairs(VFull, V4_L50_guides, cores = CORES)
V4_L100_guides_msd = calculate_msd_distance_random_pairs(VFull, V4_L100_guides, cores = CORES)
V4_L200_guides_msd = calculate_msd_distance_random_pairs(VFull, V4_L200_guides, cores = CORES)
V4_L300_guides_msd = calculate_msd_distance_random_pairs(VFull, V4_L300_guides, cores = CORES)
V4_L400_guides_msd = calculate_msd_distance_random_pairs(VFull, V4_L400_guides, cores = CORES)
V4_L500_guides_msd = calculate_msd_distance_random_pairs(VFull, V4_L500_guides, cores = CORES)

print("Calculating distance of V5...")
V5_L50_msd = calculate_msd_distance_random_pairs(VFull, V5_L50, cores = CORES)
V5_L100_msd = calculate_msd_distance_random_pairs(VFull, V5_L100, cores = CORES)
V5_L200_msd = calculate_msd_distance_random_pairs(VFull, V5_L200, cores = CORES)
V5_L300_msd = calculate_msd_distance_random_pairs(VFull, V5_L300, cores = CORES)
V5_L400_msd = calculate_msd_distance_random_pairs(VFull, V5_L400, cores = CORES)
V5_L500_msd = calculate_msd_distance_random_pairs(VFull, V5_L500, cores = CORES)

V5_L50_guides_msd = calculate_msd_distance_random_pairs(VFull, V5_L50_guides, cores = CORES)
V5_L100_guides_msd = calculate_msd_distance_random_pairs(VFull, V5_L100_guides, cores = CORES)
V5_L200_guides_msd = calculate_msd_distance_random_pairs(VFull, V5_L200_guides, cores = CORES)
V5_L300_guides_msd = calculate_msd_distance_random_pairs(VFull, V5_L300_guides, cores = CORES)
V5_L400_guides_msd = calculate_msd_distance_random_pairs(VFull, V5_L400_guides, cores = CORES)
V5_L500_guides_msd = calculate_msd_distance_random_pairs(VFull, V5_L500_guides, cores = CORES)

print("Calculating distance of V6...")
V6_L50_msd = calculate_msd_distance_random_pairs(VFull, V6_L50, cores = CORES)
V6_L100_msd = calculate_msd_distance_random_pairs(VFull, V6_L100, cores = CORES)
V6_L200_msd = calculate_msd_distance_random_pairs(VFull, V6_L200, cores = CORES)
V6_L300_msd = calculate_msd_distance_random_pairs(VFull, V6_L300, cores = CORES)
V6_L400_msd = calculate_msd_distance_random_pairs(VFull, V6_L400, cores = CORES)

V6_L50_guides_msd = calculate_msd_distance_random_pairs(VFull, V6_L50_guides, cores = CORES)
V6_L100_guides_msd = calculate_msd_distance_random_pairs(VFull, V6_L100_guides, cores = CORES)
V6_L200_guides_msd = calculate_msd_distance_random_pairs(VFull, V6_L200_guides, cores = CORES)
V6_L300_guides_msd = calculate_msd_distance_random_pairs(VFull, V6_L300_guides, cores = CORES)
V6_L400_guides_msd = calculate_msd_distance_random_pairs(VFull, V6_L400_guides, cores = CORES)

print("Calculating distance of V7...")
V7_L50_msd = calculate_msd_distance_random_pairs(VFull, V7_L50, cores = CORES)
V7_L100_msd = calculate_msd_distance_random_pairs(VFull, V7_L100, cores = CORES)
V7_L200_msd = calculate_msd_distance_random_pairs(VFull, V7_L200, cores = CORES)
V7_L300_msd = calculate_msd_distance_random_pairs(VFull, V7_L300, cores = CORES)

V7_L50_guides_msd = calculate_msd_distance_random_pairs(VFull, V7_L50_guides, cores = CORES)
V7_L100_guides_msd = calculate_msd_distance_random_pairs(VFull, V7_L100_guides, cores = CORES)
V7_L200_guides_msd = calculate_msd_distance_random_pairs(VFull, V7_L200_guides, cores = CORES)
V7_L300_guides_msd = calculate_msd_distance_random_pairs(VFull, V7_L300_guides, cores = CORES)

print("Calculating distance of V8...")
V8_L50_msd = calculate_msd_distance_random_pairs(VFull, V8_L50, cores = CORES)
V8_L100_msd = calculate_msd_distance_random_pairs(VFull, V8_L100, cores = CORES)
V8_L200_msd = calculate_msd_distance_random_pairs(VFull, V8_L200, cores = CORES)

V8_L50_guides_msd = calculate_msd_distance_random_pairs(VFull, V8_L50_guides, cores = CORES)
V8_L100_guides_msd = calculate_msd_distance_random_pairs(VFull, V8_L100_guides, cores = CORES)
V8_L200_guides_msd = calculate_msd_distance_random_pairs(VFull, V8_L200_guides, cores = CORES)

setwd(dir.save)
save.image(file = "sim_analysis_bp_msd_save.RData", compress = TRUE)

bp_msd = 
  data.frame("VFull_control_msd" = VFull_control_msd,
             "VFull_guides_msd" = VFull_guides_msd,
             "V1_L50_msd" = V1_L50_msd,
             "V1_L100_msd" = V1_L100_msd,
             "V1_L200_msd" = V1_L200_msd,
             "V1_L300_msd" = V1_L300_msd,
             "V1_L400_msd" = V1_L400_msd,
             "V1_L500_msd" = V1_L500_msd,
             "V1_L50_guides_msd" = V1_L50_guides_msd,
             "V1_L100_guides_msd" = V1_L100_guides_msd,
             "V1_L200_guides_msd" = V1_L200_guides_msd,
             "V1_L300_guides_msd" = V1_L300_guides_msd,
             "V1_L400_guides_msd" = V1_L400_guides_msd,
             "V1_L500_guides_msd" = V1_L500_guides_msd,
             "V2_L50_msd" = V2_L50_msd,
             "V2_L100_msd" = V2_L100_msd,
             "V2_L200_msd" = V2_L200_msd,
             "V2_L300_msd" = V2_L300_msd,
             "V2_L400_msd" = V2_L400_msd,
             "V2_L500_msd" = V2_L500_msd,
             "V2_L50_guides_msd" = V2_L50_guides_msd,
             "V2_L100_guides_msd" = V2_L100_guides_msd,
             "V2_L200_guides_msd" = V2_L200_guides_msd,
             "V2_L300_guides_msd" = V2_L300_guides_msd,
             "V2_L400_guides_msd" = V2_L400_guides_msd,
             "V2_L500_guides_msd" = V2_L500_guides_msd,
             "V3_L50_msd" = V3_L50_msd,
             "V3_L100_msd" = V3_L100_msd,
             "V3_L200_msd" = V3_L200_msd,
             "V3_L300_msd" = V3_L300_msd,
             "V3_L400_msd" = V3_L400_msd,
             "V3_L500_msd" = V3_L500_msd,
             "V3_L50_guides_msd" = V3_L50_guides_msd,
             "V3_L100_guides_msd" = V3_L100_guides_msd,
             "V3_L200_guides_msd" = V3_L200_guides_msd,
             "V3_L300_guides_msd" = V3_L300_guides_msd,
             "V3_L400_guides_msd" = V3_L400_guides_msd,
             "V3_L500_guides_msd" = V3_L500_guides_msd,
             "V4_L50_msd" = V4_L50_msd,
             "V4_L100_msd" = V4_L100_msd,
             "V4_L200_msd" = V4_L200_msd,
             "V4_L300_msd" = V4_L300_msd,
             "V4_L400_msd" = V4_L400_msd,
             "V4_L500_msd" = V4_L500_msd,
             "V4_L50_guides_msd" = V4_L50_guides_msd,
             "V4_L100_guides_msd" = V4_L100_guides_msd,
             "V4_L200_guides_msd" = V4_L200_guides_msd,
             "V4_L300_guides_msd" = V4_L300_guides_msd,
             "V4_L400_guides_msd" = V4_L400_guides_msd,
             "V4_L500_guides_msd" = V4_L500_guides_msd,
             "V5_L50_msd" = V5_L50_msd,
             "V5_L100_msd" = V5_L100_msd,
             "V5_L200_msd" = V5_L200_msd,
             "V5_L300_msd" = V5_L300_msd,
             "V5_L400_msd" = V5_L400_msd,
             "V5_L500_msd" = V5_L500_msd,
             "V5_L50_guides_msd" = V5_L50_guides_msd,
             "V5_L100_guides_msd" = V5_L100_guides_msd,
             "V5_L200_guides_msd" = V5_L200_guides_msd,
             "V5_L300_guides_msd" = V5_L300_guides_msd,
             "V5_L400_guides_msd" = V5_L400_guides_msd,
             "V5_L500_guides_msd" = V5_L500_guides_msd,
             "V6_L50_msd" = V6_L50_msd,
             "V6_L100_msd" = V6_L100_msd,
             "V6_L200_msd" = V6_L200_msd,
             "V6_L300_msd" = V6_L300_msd,
             "V6_L400_msd" = V6_L400_msd,
             "V6_L50_guides_msd" = V6_L50_guides_msd,
             "V6_L100_guides_msd" = V6_L100_guides_msd,
             "V6_L200_guides_msd" = V6_L200_guides_msd,
             "V6_L300_guides_msd" = V6_L300_guides_msd,
             "V6_L400_guides_msd" = V6_L400_guides_msd,
             "V7_L50_msd" = V7_L50_msd,
             "V7_L100_msd" = V7_L100_msd,
             "V7_L200_msd" = V7_L200_msd,
             "V7_L300_msd" = V7_L300_msd,
             "V7_L50_guides_msd" = V7_L50_guides_msd,
             "V7_L100_guides_msd" = V7_L100_guides_msd,
             "V7_L200_guides_msd" = V7_L200_guides_msd,
             "V7_L300_guides_msd" = V7_L300_guides_msd,
             "V8_L50_msd" = V8_L50_msd,
             "V8_L100_msd" = V8_L100_msd,
             "V8_L200_msd" = V8_L200_msd,
             "V8_L50_guides_msd" = V8_L50_guides_msd,
             "V8_L100_guides_msd" = V8_L100_guides_msd,
             "V8_L200_guides_msd" = V8_L200_guides_msd)
setwd(dir.sim.out)
saveRDS(file = "bp_msd_random_pairs.rds", object = bp_msd)
