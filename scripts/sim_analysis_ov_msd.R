################################################################################
# Sim 3
# sim_analysis_ov_msd.R
# Produce MSD metrics for overlapping HRVs and single region controls
################################################################################
...
################################################################################
CORES = 30
SAVE_FILE_NAME = "ov_msd_random_pairs.rds"
...
################################################################################
# 1: Determine if guides allow integration of overlapping regions. 
################################################################################
...
V4_V3V4_mix = calculate_msd_distance_random_pairs(VFull, V4_V3V4_mix, cores = CORES)
V4_V3V4_mix_guides = calculate_msd_distance_random_pairs(VFull, V4_V3V4_mix_guides, cores = CORES)
...
dist = data.frame("VFull" = VFull_control,
                  ...
                  "V4_V3V4_mix" = V4_V3V4_mix,
                  "V4_V3V4_mix_guides" = V4_V3V4_mix_guides)
