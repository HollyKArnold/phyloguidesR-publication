...
SAVE_FILENAME = "nonov_mcd_random_pairs.rds"
...
V5V7 = calculate_mcd_distance_random_pairs(VFull, V5V7, cores = CORES)
...
V5V7_guides = calculate_mcd_distance_random_pairs(VFull, V5V7_guides, cores = CORES)

V1V2_V3V4_V5V7_mix = calculate_mcd_distance_random_pairs(VFull, V1V2_V3V4_V5V7_mix, cores = CORES)
V1V2_V3V4_V5V7_mix_guides = calculate_mcd_distance_random_pairs(VFull, V1V2_V3V4_V5V7_mix_guides, cores = CORES)
