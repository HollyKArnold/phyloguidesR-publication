...
SAVE_FILENAME = "nonov_jrf_random_pairs.rds"
...
V5V7 = calculate_jrf_distance_random_pairs(VFull, V5V7, cores = CORES)
...
V5V7_guides = calculate_jrf_distance_random_pairs(VFull, V5V7_guides, cores = CORES)

V1V2_V3V4_V5V7_mix = calculate_jrf_distance_random_pairs(VFull, V1V2_V3V4_V5V7_mix, cores = CORES)
V1V2_V3V4_V5V7_mix_guides = calculate_jrf_distance_random_pairs(VFull, V1V2_V3V4_V5V7_mix_guides, cores = CORES)
